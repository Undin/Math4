 ...
 */
public class ImplicitDownstreamScheme extends AbstractImplicitScheme {

    public ImplicitDownstreamScheme(double velocity, double kappa, double dx, double dt, double[] initialValues) {
